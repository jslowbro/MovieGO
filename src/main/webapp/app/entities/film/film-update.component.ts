...
export class FilmUpdateComponent implements OnInit {
  ...
  updateForm(film: IFilm): void {
    this.editForm.patchValue({
      ...
      personContainers: film.personContainers
    });
  }
  ...
  private createFromForm(): IFilm {
    return {
      ...
      personContainers: this.editForm.get(['personContainers'])!.value
    };
  }
  ...
  getSelected(selectedVals: IPersonContainer[], option: IPersonContainer): IPersonContainer {
    if (selectedVals) {
