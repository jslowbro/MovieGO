...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, com.janchabik.moviego.domain.Region.class.getName());
            createCache(cm, com.janchabik.moviego.domain.Country.class.getName());
            createCache(cm, com.janchabik.moviego.domain.Location.class.getName());
            createCache(cm, com.janchabik.moviego.domain.Department.class.getName());
            createCache(cm, com.janchabik.moviego.domain.Department.class.getName() + ".employees");
            createCache(cm, com.janchabik.moviego.domain.Task.class.getName());
            createCache(cm, com.janchabik.moviego.domain.Task.class.getName() + ".jobs");
            createCache(cm, com.janchabik.moviego.domain.Employee.class.getName());
            createCache(cm, com.janchabik.moviego.domain.Employee.class.getName() + ".jobs");
