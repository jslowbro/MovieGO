...
import com.janchabik.moviego.domain.Job;
import com.janchabik.moviego.repository.JobRepository;
...
/**
 * REST controller for managing {@link com.janchabik.moviego.domain.Job}.
 */
@RestController
@RequestMapping("/api")
@Transactional
